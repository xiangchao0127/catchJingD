...
经过半年的开发，公积金一期终于告一段落，终于有时间来总结下技术点。

- **dubbo分布式框架搭建**
- **Spring+hibernate+resteasy+mysql 框架搭建**
- **Enum  static 泛型 反射 spring aop 事物 设计模式 自定义注解 的深入理解**
- **编码规范 深度包装保证高可用 序列化问题 匿名内部类重新添加引用**
- **java 锁的初步了解**
- **引用传参的灵活性 **
- **Mysql的视图，trigger，函数理解，sql语句的加深**
- **分布式事物的瓶颈**
