...
public class MYSQLControl {
    ...
    //根据自己的数据库地址修改
    static DataSource ds = MyDataSource.getDataSource("jdbc:mysql://127.0.0.1:3306/test?ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin&serverTimezone=Hongkong");
